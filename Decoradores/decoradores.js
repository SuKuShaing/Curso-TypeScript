...
var Persona2 = function () {
    var _classDecorators = [PersonaDec];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var Persona2 = _classThis = /** @class */ (function () {
        function Persona2_1(nombre, edad) {
            this.nombre = nombre;
            this.edad = edad;
        }
        Persona2_1.prototype.saludar = function (saludo) {
...
var usuario = new Persona2("Juan", 20);

...
var Empleado = /** @class */ (function (_super) {
    ...
    Empleado.prototype.saludar = function () {
        return "Hola, me llamo ".concat(this.nombre, ", y trabajo de ").concat(this.puesto, ".");
    };
    Empleado.prototype.obtenerInfo = function () {
        return "Hola, me llamo ".concat(this.nombre, ", tengo ").concat(this.edad, " a\u00F1os y trabajo de ").concat(this.puesto, ".");
    };
    return Empleado;
}(clase_1.Persona));
